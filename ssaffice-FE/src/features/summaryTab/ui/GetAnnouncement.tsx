    ...
    <div>
      ...
      <ul className='flex flex-col border-t px-spacing-4 py-spacing-10 border-color-border-info gap-y-spacing-10 text-color-text-primary'>
        <li className='flex items-center body-md-medium min-w-max'>
          전체 <span className='ml-spacing-8'>{noticeCounts?.total}</span>
        </li>
        <li className='flex items-center body-md-medium min-w-max'>
          중요{' '}
          <span className='ml-spacing-8 text-color-text-danger'>{noticeCounts?.essential}</span>
        </li>
        <li className='flex items-center body-md-medium min-w-max'>
          등록{' '}
          <span className='ml-spacing-8 text-color-text-info-bold'>{noticeCounts?.enrolled}</span>
        </li>
      </ul>
    </div>
  )
